...
\begin{tikzpicture}[node distance=0.4cm and 0.5cm]
  ...
  % ── Shared Memory (spans from orchestrator to agents) ──
  \node[memory, below=0.5cm of ag2, minimum width=3.8cm, minimum height=0.55cm] (shmem) {Mem\'oria Compartilhada};
  ...
  \draw[secondary] (ag2.south) -- (shmem.north);
